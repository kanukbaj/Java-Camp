module ders5Odev1 {
	...
	//Bir e-ticaret sisteminde sisteme kayýt ve sisteme giriþ için gerekli gereksinim ve Kabul kriterleri
	
	//Kullanýcýlar sisteme bilgilerini girerek üye olabilmelidir.

	//Sisteme temel kullanýcý bilgileri , e-posta ve parolayla üye olunabilmelidir. Temel kullanýcý bilgileri : ad, soyad, e-posta, parola. Temel bilgilerin tamamý zorunludur.
	...
	//Ýlerleyen zamanlarda baþka yetkilendirme servisleri de kullanýlabilir. (Sistemi dýþ servis entegrasyonu olacak þekilde yapýlandýrýnýz.)
	//Hatalý veya baþarýlý durumda kullanýcý bilgilendirilmelidir.
